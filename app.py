...
st.title('Print media Word Embedding Visualization Based on Cosine Similarity')

st.header('This is a web app to visualize word embeddings from articles around aadhaar. The corpus consists of close to 13,000 artciles taken from 11 english news papers')
